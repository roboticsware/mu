...
class Window(QMainWindow):
    ...
    def add_filesystem(self, home, file_manager, board_name="board"):
        ...
        self.fs_pane.microbit_fs.is_dir.connect(file_manager.is_dir)
        self.fs_pane.microbit_fs.list_files.connect(file_manager.ls)
        self.fs_pane.microbit_fs.itemDoubleClicked.connect(self.fs_pane.microbit_fs.on_item_double_clicked)
        ...
        self.fs_pane.local_fs.local_delete.connect(file_manager.local_delete)
